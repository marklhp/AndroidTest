...
public class CryptoObjectHelper {
    ...
    Key GetKey() throws Exception{
        ...
        secreKey=_keystore.getKey(KEY_NAME,null);
        return secreKey;
    }
    ...
    void CreateKey() throws Exception{
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            keyGenParameterSpec = new KeyGenParameterSpec.Builder(KEY_NAME, KeyProperties.PURPOSE_ENCRYPT|KeyProperties.PURPOSE_DECRYPT)
