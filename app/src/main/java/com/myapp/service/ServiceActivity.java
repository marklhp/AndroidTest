...
import com.myapp.R;
import com.myapp.activity.EditActivity;
...
public class ServiceActivity extends Activity{
    ...
    void init() {
        ...
        findViewById(R.id.bt_newview).setOnClickListener(clickListener);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.image:
                    ...
                    break;
                case R.id.bt_newview:
                    startActivity(new Intent(ServiceActivity.this,EditActivity.class));
                    break;
            }
        }
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode==0&&event==null) Toast.makeText(ServiceActivity.this,keyCode+"---"+event.toString(),Toast.LENGTH_SHORT).show();
