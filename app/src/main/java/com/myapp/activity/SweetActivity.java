...
public class SweetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.custom_img_custom).setOnClickListener(this);
    }
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.custom_img_custom:
                SweetDialog s=new SweetDialog(this);

                s.mDialogView.addView(View.inflate(this,R.layout.activity_constration,null));
                s.show();
                break;
        }
    }
